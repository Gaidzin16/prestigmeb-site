    ...
    <div class="article rise">
      ...
      <table class="spec-table">
        <tbody>
          ...
          <tr><th scope="row">Досрочное погашение</th><td>В любой момент, без ограничений</td></tr>
          <tr><th scope="row">Акции</th><td>Действуют и при рассрочке</td></tr>
      ...
      <div class="prose" style="margin-top:var(--space-xl)">
        ...
        <p>Договор оформляется в салоне на Грибоедова, там же вносится первый взнос. Платежи приносите
          в офис или переводите — как удобнее. Как гасить — по графику или досрочно — решаете сами:
          закрыть рассрочку раньше срока можно в любой момент.</p>
